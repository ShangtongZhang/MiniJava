...
MiniJavaLexer.T__36 = 37;
MiniJavaLexer.T__37 = 38;
MiniJavaLexer.T__38 = 39;
MiniJavaLexer.T__39 = 40;
MiniJavaLexer.T__40 = 41;
MiniJavaLexer.T__41 = 42;
MiniJavaLexer.T__42 = 43;
MiniJavaLexer.T__43 = 44;
MiniJavaLexer.T__44 = 45;
MiniJavaLexer.T__45 = 46;
MiniJavaLexer.T__46 = 47;
MiniJavaLexer.INTEGER = 48;
MiniJavaLexer.IDENTIFIER = 49;
MiniJavaLexer.LINE_COMMENT = 50;
MiniJavaLexer.COMMENT = 51;
MiniJavaLexer.WS = 52;


MiniJavaLexer.modeNames = [ "DEFAULT_MODE" ];

MiniJavaLexer.literalNames = [ 'null', "'class'", "'extends'", "'{'", "'}'", 
                               "'public'", "';'", "'static'", "'void'", 
                               "'main'", "'('", "'String'", "'['", "']'", 
                               "')'", "','", "'boolean'", "'int'", "'if'", 
                               "'else'", "'while'", "'System'", "'.'", "'out'", 
                               "'println'", "'return'", "'='", "'new'", 
                               "'-'", "'!'", "'*'", "'/'", "'%'", "'+'", 
                               "'<='", "'>='", "'>'", "'<'", "'=='", "'!='", 
                               "'&'", "'|'", "'&&'", "'||'", "'this'", "'null'", 
...
MiniJavaLexer.symbolicNames = [ 'null', 'null', 'null', 'null', 'null', 
                                ...
                                'null', 'null', 'null', 'null', 'null', 
                                'null', 'null', 'null', 'null', 'null', 
                                'null', 'null', 'null', "INTEGER", "IDENTIFIER", 
                                "LINE_COMMENT", "COMMENT", "WS" ];

MiniJavaLexer.ruleNames = [ "T__0", "T__1", "T__2", "T__3", "T__4", "T__5", 
                            ...
                            "INTEGER", "IDENTIFIER", "LETTER", "JAVAIDDIGIT", 
                            "DIGIT", "LINE_COMMENT", "COMMENT", "WS" ];

MiniJavaLexer.grammarFileName = "MiniJava.g4";
